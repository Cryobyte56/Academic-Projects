          ...
          <div class="col-12 col-xl-11">
            ...
            <div class="d-flex mb-5">
              <div class="me-4 text-primary">
                ...
                <link rel="stylesheet" href="https://unpkg.com/bs-brain@2.0.2/components/contacts/contact-3/assets/css/contact-3.css" />


              </div>
              <div>
                <h4 class="mb-3">Address</h4>
                <address class="mb-0 text-secondary">900 SAN MARCELINO ST., ERMITA 1000 MANILA</address>
              </div>
            </div>
            <div class="row mb-5">
              ...
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">adamson.edu.ph</a>
                    </p>
                  </div>
                </div>
              </div>
